package app.locationfac.ressources.animation.loadingdrawable.render.circle.rotate;
...
import app.locationfac.ressources.animation.loadingdrawable.DensityUtil;
...
public class GearLoadingRenderer extends LoadingRenderer {
    ...
    private static final int DEFAULT_COLOR = Color.parseColor("#c60121");
